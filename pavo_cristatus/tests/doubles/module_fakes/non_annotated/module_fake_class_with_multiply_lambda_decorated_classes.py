...
__all__ = ["ModuleFakeClassWithMultiplyLambdaDecoratedClass"]

class ModuleFakeClassWithMultiplyLambdaDecoratedClass(interoperable_with_metaclass_future(ModuleFakeClass)):
